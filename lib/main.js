...
// Add-on SDK 1.13 makes this irrelevant
//PageMod({
  //include: /.*\.((jpg)|(png)|(gif))/,
  //contentScriptFile: [ data.url('services_core.js'), data.url('dat_new_new.js') ],
  //onAttach: function(aWorker) {
    //aWorker.port.emit('makeContextMenu', _('pin_image'), data.url('favicon.ico'));
    //aWorker.on('message', pinHandler);
  //}
//});
